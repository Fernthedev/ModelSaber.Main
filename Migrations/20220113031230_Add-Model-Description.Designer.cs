...
namespace ModelSaber.Main.Migrations
{
    ...
    [Migration("20220113031230_Add-Model-Description")]
    partial class AddModelDescription
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ModelSaber.Database.Models.UserLogons", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("ModelSaber.Database.Models.UserTags", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("ModelSaber.Database.Models.Vote", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("ModelSaber.Database.Models.UserLogons", b =>
                {
                    b.HasOne("ModelSaber.Database.Models.User", "User")
                        .WithOne("Logon")
                        .HasForeignKey("ModelSaber.Database.Models.UserLogons", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
